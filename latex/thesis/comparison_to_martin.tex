...
The columns of~\Cref{tab:cplex_vs_gurobi} are:
...
The columns of~\Cref{tab:easy18} are similar to the ones present in \Cref{tab:cu_cw} and \Cref{tab:fmt59_apt}; exceptions are noted close to each table.
