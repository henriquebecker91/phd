...
%In both cases, our re-implementation was used.
...
%The time spent solving the models is not a good criteria across different computers and solvers (or versions of the same solver).
% The data from the original implementation was obtained from THOMO. % ALREADY SAID BELOW
...
%In Table XXX it is shown that this choice only affects the last three rows.
...
%The purpose of this section is to present the effects of the proposed improvements in comparison to FURINI/THOMO;
%(2) 
In this section, we present the effects of the improvements we proposed.



% TODO: remeber to mention that two instances of the Original failed
% because of memory not timeout (but their time is being counted in the total)
