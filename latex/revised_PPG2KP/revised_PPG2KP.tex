...
\end{scope}
\end{tikzpicture}
\caption{\newtext{Diagram of~\cref{ex:renormalization_after_cut}: (a) the three copies of the first piece stacked; (b) the second and third pieces side-by-side; (c) both children of an horizontal normal cut over a normalized plate are not normalized themselves.}}
\end{figure}
