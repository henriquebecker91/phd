...
The G2KP is an NP-hard problem~\citep{russo:2020}.
...
The G2KP with \emph{unconstrained demand} is not NP-hard; exact algorithms of pseudo-polynomial time complexity exist~\citep{beasley:1985}.
...
\citet{iori:2020} catalogues exact methods and relaxations for 2D cutting problems including guillotine problems.
\citet{russo:2020} reviews the literature of our particular problem at length -- there G2KP is referred to as Constrained 2D Cutting or C2DC.
Moreover, \citet{russo:2020}~points out three strategies employed by previous exact solving methods which cause loss of optimality.
...
\citet{herz:1972}~proposed a dominance rule for the G2KP with unconstrained demand based on the same principle and warned about the possibility of misusing the rule in the constrained case.
...
A similar theorem and proof appear in~\citet{song:2010}.
